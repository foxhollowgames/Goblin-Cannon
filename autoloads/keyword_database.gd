...
const KEYWORDS: Dictionary = {
	...
	"Explosions": "Damages nearby pegs.",
	"Explosion": "Damages nearby pegs.",
	"Explosive": "Detonates on peg contact to damage nearby pegs.",
	"Energize": "Adds temporary durability to a peg (max 3 stacks).",
	"Energized": "Shows temporary durability added by Energize (max 3 stacks).",
	"Pop Bumpers": "Kinetic pinball bumpers that knock balls away on contact.",
	"Pop Bumper": "Kinetic pinball bumper that knocks balls away on contact.",
	"Bumpers": "Kinetic pinball bumpers that knock balls away on contact.",
	"Bumper": "Kinetic pinball bumper that knocks balls away on contact.",
	"Siphons": "Draws Energy from passing balls into collection reservoirs.",
	"Siphon": "Draws Energy from passing balls into collection reservoirs.",
	...
	"Draining": "Drains Energy from pegs over time.",
	"Phase": "Phases through pegs to collect Energy.",
	"Blast": "Damages nearby pegs.",
