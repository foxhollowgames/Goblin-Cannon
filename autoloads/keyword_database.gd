...
const KEYWORDS: Dictionary = {
	"Chain Lightning": "Discharges electricity on hit that arcs to nearby valid pegs.",
	"Lucky Gold Pegs": "Special pegs that award +1 or +5 run Gold when hit by a ball.",
	"Lucky Gold Peg": "Special peg that awards +1 or +5 run Gold when hit by a ball.",
	"Gravity Well Peg": "Special peg that slows down balls passing near its field.",
	"Gravity Well": "Special peg that slows down balls passing near its field.",
	"Extreme Bouncer": "Special peg that bounces balls with very high speed.",
	"Trampoline Peg": "Special peg that launches balls upward with high velocity on impact.",
	"Splitter Peg": "Special peg that splits any ball that hits it into two balls.",
	"Goblin Reset": "Special peg that catches balls and returns them to the top hopper.",
	"Eternal Peg": "Special peg that instantly restores its durability to full when broken.",
	"Main Cannon": "Artillery weapon charged by Energy that attacks enemy fortification walls.",
	"Phase Peg": "Special peg that alternates between solid and ghost states on a timer.",
	"Wrench Peg": "Special peg that instantly repairs broken pegs when hit.",
	"Magnet Peg": "Special peg that pulls nearby balls toward itself with a magnetic field.",
	"Gold Pegs": "Special pegs that generate 3× Energy when hit by a ball.",
	"Gold Peg": "Special peg that generates 3× Energy when hit by a ball.",
	"Bomb Peg": "Special peg that explodes on hit, damaging all pegs in its blast radius.",
	"Plain Balls": "Standard balls that generate Energy from peg hits.",
	"Constellation": "Fires laser beams between active balls on the board.",
	"Explosions": "Area damage that damages multiple pegs and pushes nearby balls.",
	"Explosion": "Area damage that damages multiple pegs and pushes nearby balls.",
	"Supernova": "Triggers when a peg reaches maximum Energize (3 stacks), causing a large explosion.",
	"Energize": "Adds a stack to a peg (max 3). Energized pegs grant bonus Energy and repair faster.",
	"Drop End": "Triggers when a ball reaches the bottom exit of the board.",
	"On Expiry": "Triggers when a temporary status effect duration ends.",
	"On Break": "Triggers when a peg loses all durability and breaks.",
	"On Hit": "Triggers whenever a ball collides with a peg.",
	"Overdrive": "Triggers when a ball reaches the target number of peg hits during a single drop.",
	"Volatile": "Releases gas clouds that accelerate balls that pass through them.",
	"Fragments": "Smaller ball pieces created after a Split ball hits a peg.",
	"Fragment": "A smaller ball piece created after a Split ball hits a peg.",
	"Phantom": "Phases through pegs without colliding while collecting Energy.",
	"Intangible": "Phases through pegs without colliding while collecting Energy.",
	"Rubbery": "Extra bouncy ball that gains speed from bounces.",
	"Binary": "Splits when it collides with another Binary ball.",
	"Cannon": "Artillery weapon charged by Energy that attacks enemy fortification walls.",
	"Hopper": "Chute that feeds balls onto the board from the top.",
	"Leech": "Applies Drain to struck pegs, generating Energy over time.",
	"Drain": "Drains Energy from the peg every second for a limited duration.",
	"Phase": "Phases through pegs without colliding while collecting Energy.",
	"Blast": "Area damage that damages multiple pegs and pushes nearby balls.",
	"Split": "Divides into multiple smaller fragments that bounce independently.",
	"Bloom": "Creates flora multipliers on struck pegs that burst for bonus Energy.",
	"Gate": "Timed door at the top of the board that opens to drop balls.",
	"Plain": "Standard ball that generates Energy from peg hits.",
	"Energy": "Power generated from peg hits and drops to charge the Main Cannon."
}
