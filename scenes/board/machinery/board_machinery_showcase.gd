...
static func _get_impulser_definitions() -> Array[Dictionary]:
	return [
		...
		_single_def(&"debug_outlane_kickback_1x1", "Outlane Kickback (1x1)", Vector2i(5, 4), CellType.OUTLANE_KICKBACK, Vector2i.ZERO, "Active Impulser", "Emergency solenoid plunger located in bottom gutter outlanes. Explosive spring fires upon ball entry, punching ball back onto main playfield.", {"Classification": "Active Impulser", "Footprint": "1x1 (1 Cell)", "Energy": "+8 Energy", "Impulse": "480 px/s (Emergency Up)"})
	]
...
static func _get_directional_definitions() -> Array[Dictionary]:
	return [
		...
		_single_def(&"debug_deflector_down", "Directional Deflector (Down)", Vector2i(7, 0), CellType.DIRECTIONAL_DEFLECTOR, Vector2i.DOWN, "Active Impulser", "Angled steel wedge baffle. Deflects colliding balls downward into designated orientation angle regardless of incoming approach vector.", {"Classification": "Active Impulser", "Footprint": "1x1 (1 Cell)", "Energy": "+4 Energy", "Impulse": "350 px/s (Fixed Angle)", "Direction": "DOWN"}),
		_single_def(&"debug_deflector_up", "Directional Deflector (Up)", Vector2i(7, 1), CellType.DIRECTIONAL_DEFLECTOR, Vector2i.UP, "Active Impulser", "Angled steel wedge baffle. Deflects colliding balls upward into designated orientation angle regardless of incoming approach vector.", {"Classification": "Active Impulser", "Footprint": "1x1 (1 Cell)", "Energy": "+4 Energy", "Impulse": "350 px/s (Fixed Angle)", "Direction": "UP"}),
		_single_def(&"debug_deflector_left", "Directional Deflector (Left)", Vector2i(7, 2), CellType.DIRECTIONAL_DEFLECTOR, Vector2i.LEFT, "Active Impulser", "Angled steel wedge baffle. Deflects colliding balls westward into designated orientation angle regardless of incoming approach vector.", {"Classification": "Active Impulser", "Footprint": "1x1 (1 Cell)", "Energy": "+4 Energy", "Impulse": "350 px/s (Fixed Angle)", "Direction": "LEFT"}),
		_single_def(&"debug_deflector_right", "Directional Deflector (Right)", Vector2i(7, 3), CellType.DIRECTIONAL_DEFLECTOR, Vector2i.RIGHT, "Active Impulser", "Angled steel wedge baffle. Deflects colliding balls eastward into designated orientation angle regardless of incoming approach vector.", {"Classification": "Active Impulser", "Footprint": "1x1 (1 Cell)", "Energy": "+4 Energy", "Impulse": "350 px/s (Fixed Angle)", "Direction": "RIGHT"})
	]
...
static func _get_target_trap_definitions() -> Array[Dictionary]:
	return [
		...
		_single_def(&"debug_standup_target_1x1", "Standup Target (1x1)", Vector2i(8, 1), CellType.STANDUP_TARGET, Vector2i.ZERO, "Target", "Rigid upright target plate mounted on flexible leaf switch. Resists ball passage and applies sharp rebound velocity backwards.", {"Classification": "Target", "Footprint": "1x1 (1 Cell)", "Energy": "+4 Energy", "Impulse": "320 px/s (Rebound)"}),
...
static func _get_sensor_route_definitions() -> Array[Dictionary]:
	return [
		...
		_single_def(&"debug_mana_siphon_1x1", "Mana Siphon (1x1)", Vector2i(10, 2), CellType.MANA_SIPHON, Vector2i.ZERO, "Sensor", "Mystical runic energy ring. Balls pass through freely without physical obstruction, converting kinetic energy into raw mana.", {"Classification": "Sensor", "Footprint": "1x1 (1 Cell)", "Energy": "+5 Energy", "Impulse": "0 px/s (Permeable)"}),
