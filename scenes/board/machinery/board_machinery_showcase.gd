...
static func _get_multi_cell_definitions() -> Array[Dictionary]:
	...
	return [
		...
		_item_def(&"debug_abyssal_maw", "Abyssal Maw Ball Trap (2x2)", Vector2i(3, 2), box, MachineryLayoutMode.UNIFIED, CellType.BALL_TRAP, {}, {}, "Trap", "Multi-ball trap. Traps multiple passing balls simultaneously, holds them for charging, then ejects them in a violent outward volley.", {"Classification": "Trap", "Footprint": "2x2 (4 Cells)", "Energy": "+25 Energy", "Impulse": "480 px/s (Volley Eject)", "Hold Time": "0.85s"}),
...
static func _get_sensor_route_definitions() -> Array[Dictionary]:
	return [
		...
		_single_def(&"debug_wire_gate_1x1", "Wire Gate (1x1)", Vector2i(10, 3), CellType.WIRE_GATE, Vector2i.ZERO, "Sensor", "Hinged retentive wire gate. Catches and retains downward falling balls in a holding cup until 3 balls accumulate, then triggers a cascade release.", {"Classification": "Sensor", "Footprint": "1x1 (1 Cell)", "Energy": "+4 Energy / +14 Cascade", "Impulse": "320 px/s (Cascade)", "Capacity": "3 Balls"}),
