...
| [TASK-078](file:///c:/Users/josep/Desktop/Games/Goblin-Cannon/docs/tasks/TASK-078-remove-outlane-kickback-machinery.md) | Remove Outlane Kickback Machinery Component from the Game | Systems / Cleanup | P1 | REVIEW | `feature/remove-outlane-kickback-machinery` |
