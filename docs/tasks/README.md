...
| [TASK-031](file:///c:/Users/josep/Desktop/Games/Goblin-Cannon/docs/tasks/TASK-031-board-relic-repositioning-and-dragging.md) | Board Relic Repositioning and In-Place Dragging | UI/Controls | P1 | IN_REVIEW | `feature/board-relic-repositioning` |
