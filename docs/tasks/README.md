...
| [TASK-037](file:///c:/Users/josep/Desktop/Games/Goblin-Cannon/docs/tasks/TASK-037-tooltip-text-and-language-refinement.md) | Tooltip Text and Language Refinement | UI/Polish | P1 | READY | `feature/tooltip-text-refinement` |
