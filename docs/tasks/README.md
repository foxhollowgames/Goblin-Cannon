...
| [TASK-077](file:///c:/Users/josep/Desktop/Games/Goblin-Cannon/docs/tasks/TASK-077-remove-standup-target-machinery.md) | Remove Standup Target Machinery Component from the Game | Systems / Cleanup | P1 | READY | `feature/remove-standup-target-machinery` |
