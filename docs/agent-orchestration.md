...
- **Automatic Task Packet Creation:** When ad-hoc instructions or bug reports are received without an existing task, create a task packet under `docs/tasks/`, register it in `docs/tasks/README.md`, and regenerate the dashboard before starting implementation.
