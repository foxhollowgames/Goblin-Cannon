...
static func _build_boss_amplifiers() -> void:
	...
	_def(&"renewal_pact", "Renewal Pact", 3, "4x3 Solenoid Field", "3 Slingshots + 2 Repair Siphons + 5 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(1,1), Vector2i(2,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(0,0): CellType.SLINGSHOT, Vector2i(3,0): CellType.SLINGSHOT, Vector2i(1,1): CellType.SLINGSHOT, Vector2i(0,2): CellType.MANA_SIPHON, Vector2i(3,2): CellType.MANA_SIPHON}, {})
