...
static func _get_goal_def(id: StringName) -> Dictionary:
	var defs: Dictionary = {
		...
		&"fragment_swarm": {"type": GoalArchetype.SINKHOLE_LOCK, "reward": RewardType.MULTIBALL_CASCADE, "title": "Swarm Chute", "desc": "Catch ball in ball trap.", "activation_req": "Catch ball in ball trap.", "reward_desc": "Multiball Cascade (4 swarm balls)", "balls": 4, "required_widget": CellType.BALL_TRAP, "threshold": 1},
		...
		&"overcharged_drain": {"type": GoalArchetype.SINKHOLE_LOCK, "reward": RewardType.ENERGY_SURGE, "title": "Funnel Drain", "desc": "Catch ball in ball trap.", "activation_req": "Catch ball in ball trap.", "reward_desc": "+130 Energy Surge to ball", "energy": 130, "required_widget": CellType.BALL_TRAP, "threshold": 1},
		...
		&"max_energize_stacks": {"type": GoalArchetype.SINKHOLE_LOCK, "reward": RewardType.BOARD_SUPERCHARGE, "title": "Dual Capacitor", "desc": "Catch ball in ball trap.", "activation_req": "Catch ball in ball trap.", "reward_desc": "Board Supercharge (+2 Energize stacks)", "required_widget": CellType.BALL_TRAP, "threshold": 1},
		...
		&"devastating_barrage": {"type": GoalArchetype.TARGET_BANK, "reward": RewardType.GLOBAL_BOARD_KNOCK, "title": "Heavy Barrage", "desc": "Knock down targets.", "activation_req": "Knock down targets.", "reward_desc": "Global Board Knock (All pegs hit once)", "required_widget": CellType.DROP_TARGET, "threshold": 2},
...
static func _build_boss_amplifiers() -> void:
	...
	_def(&"fragment_swarm", "Fragment Swarm", 3, "3x4 Giant Arch", "Ball Trap + 2 Guide Rails + 2 Heavy Bumpers", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(0,1), Vector2i(2,1), Vector2i(0,2), Vector2i(2,2), Vector2i(0,3), Vector2i(1,3), Vector2i(2,3), Vector2i(1,2)], {Vector2i(1,0): CellType.BALL_TRAP, Vector2i(0,1): CellType.GUIDE_RAIL, Vector2i(2,1): CellType.GUIDE_RAIL, Vector2i(0,3): CellType.BUMPER, Vector2i(2,3): CellType.BUMPER}, {Vector2i(1,0): Vector2i.DOWN}, {}, PolyominoModuleData.EnclosureType.DIRECTIONAL_FUNNEL)
...
static func _build_wall_break_cross_links() -> void:
	...
	_def(&"overcharged_drain", "Overcharged Drain", 2, "3x3 L-Chamber", "1 Ball Trap + 2 Pop Bumpers + 1 Bumper", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2)], {Vector2i(0,0): CellType.BALL_TRAP, Vector2i(0,1): CellType.POP_BUMPER, Vector2i(0,2): CellType.POP_BUMPER, Vector2i(2,2): CellType.BUMPER}, {})
...
static func _build_treasure_chest_passives() -> void:
	...
	_def(&"max_energize_stacks", "Deeper Energize", 1, "2x2 Box Chamber", "1 Ball Trap + 1 Pop Bumper + 2 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.BALL_TRAP, Vector2i(1,1): CellType.POP_BUMPER}, {})
