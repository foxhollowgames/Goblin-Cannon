...
static func _build_boss_amplifiers() -> void:
	...
	_def(&"echoes_of_wrench", "Echoes of the Wrench", 3, "4x3 T-Beam Frame", "2 Drop Targets + 2 Repair Siphons + 1 Central Booster", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1), Vector2i(3,1), Vector2i(1,2), Vector2i(2,2)], {Vector2i(0,0): CellType.DROP_TARGET, Vector2i(3,0): CellType.DROP_TARGET, Vector2i(1,0): CellType.MANA_SIPHON, Vector2i(2,2): CellType.MANA_SIPHON, Vector2i(1,1): CellType.ROTARY_BOOSTER}, {})
