...
static func get_relic_activation_requirement(relic_id: StringName) -> String:
	var g: Dictionary = _get_goal_def(relic_id)
	return str(g["activation_req"]) if g.has("activation_req") else get_relic_goal_description(relic_id)
...
static func _get_goal_def(id: StringName) -> Dictionary:
	var defs: Dictionary = {
		...
		&"rubber_storm": {"type": GoalArchetype.SUPER_JETS, "reward": RewardType.CONCUSSIVE_OVERDRIVE, "title": "Triangle Ricochet", "desc": "Hit pop bumpers.", "activation_req": "Hit pop bumpers.", "reward_desc": "+180 Energy Surge to ball", "energy": 180, "required_widget": CellType.POP_BUMPER, "threshold": 3},
		&"fragment_swarm": {"type": GoalArchetype.SINKHOLE_LOCK, "reward": RewardType.MULTIBALL_CASCADE, "title": "Swarm Reservoir", "desc": "Fill wire gate retention cup.", "activation_req": "Fill wire gate reservoir.", "reward_desc": "Multiball Cascade (4 swarm balls)", "balls": 4, "required_widget": CellType.WIRE_GATE, "threshold": 3},
		...
		&"crown_ricochet": {"type": GoalArchetype.SUPER_JETS, "reward": RewardType.ENERGY_SURGE, "title": "Crown Ricochet", "desc": "Hit crown pop bumpers.", "activation_req": "Hit pop bumpers.", "reward_desc": "+150 Energy Surge to ball", "energy": 150, "required_widget": CellType.POP_BUMPER, "threshold": 3},
		&"twin_mandate": {"type": GoalArchetype.ORBIT_FLOW, "reward": RewardType.ENERGY_SURGE, "title": "Dual Rail Route", "desc": "Traverse orbit loops.", "activation_req": "Traverse orbit loops.", "reward_desc": "+160 Energy Surge to ball", "energy": 160, "target_count": 2, "required_widget": CellType.ORBIT_LOOP, "threshold": 2},
		...
		&"echoes_of_wrench": {"type": GoalArchetype.TARGET_BANK, "reward": RewardType.ENERGY_SURGE, "title": "Wrench Circuit", "desc": "Knock down targets.", "activation_req": "Knock down targets.", "reward_desc": "+175 Energy Surge to ball", "energy": 175, "required_widget": CellType.DROP_TARGET, "threshold": 2},
		...
		&"phantom_resonance": {"type": GoalArchetype.SEQUENCE_ROUTE, "reward": RewardType.BOARD_SUPERCHARGE, "title": "Spectral Network", "desc": "Traverse guide track.", "activation_req": "Traverse guide track.", "reward_desc": "Board Supercharge (+3 Energize stacks)", "required_widget": CellType.GUIDE_TRACK, "threshold": 1},
		&"supernova_peg": {"type": GoalArchetype.TARGET_BANK, "reward": RewardType.CONCUSSIVE_OVERDRIVE, "title": "Supernova Ignition", "desc": "Knock down targets.", "activation_req": "Knock down targets.", "reward_desc": "+130 Energy Surge to ball", "energy": 130, "required_widget": CellType.DROP_TARGET, "threshold": 2},
		&"chain_conduction": {"type": GoalArchetype.SUPER_JETS, "reward": RewardType.ENERGY_SURGE, "title": "Conduction Circuit", "desc": "Hit pop bumpers.", "activation_req": "Hit pop bumpers.", "reward_desc": "+120 Energy Surge to ball", "energy": 120, "required_widget": CellType.POP_BUMPER, "threshold": 2},
		&"overcharged_drain": {"type": GoalArchetype.SINKHOLE_LOCK, "reward": RewardType.ENERGY_SURGE, "title": "Retention Reservoir", "desc": "Fill wire gate cup to burst.", "activation_req": "Fill wire gate reservoir.", "reward_desc": "+130 Energy Surge to ball", "energy": 130, "required_widget": CellType.WIRE_GATE, "threshold": 1},
		&"final_arc_detonation": {"type": GoalArchetype.LAUNCH_RAMP, "reward": RewardType.CONCUSSIVE_OVERDRIVE, "title": "Arc Hurry-Up", "desc": "Enter vertical up kicker.", "activation_req": "Enter vertical up kicker.", "reward_desc": "+125 Energy Surge to ball", "energy": 125, "required_widget": CellType.VERTICAL_UP_KICKER, "threshold": 1},
		&"energy_collapse": {"type": GoalArchetype.TARGET_BANK, "reward": RewardType.GLOBAL_BOARD_KNOCK, "title": "Collapse Matrix", "desc": "Knock down targets.", "activation_req": "Knock down targets.", "reward_desc": "Global Board Knock (All pegs hit once)", "required_widget": CellType.DROP_TARGET, "threshold": 2},
		...
		&"arc_twins": {"type": GoalArchetype.SEQUENCE_ROUTE, "reward": RewardType.ENERGY_SURGE, "title": "Twin Arc Bridge", "desc": "Traverse guide tracks.", "activation_req": "Traverse guide tracks.", "reward_desc": "+125 Energy Surge to ball", "energy": 125, "required_widget": CellType.GUIDE_TRACK, "threshold": 2},
		&"phase_siphon": {"type": GoalArchetype.ROLLOVER_SPELL, "reward": RewardType.ENERGY_SURGE, "title": "W-I-N Word Bank", "desc": "Spell W-I-N across divided lanes.", "activation_req": "Spell W-I-N across lanes.", "reward_desc": "+100 Energy Surge to ball", "energy": 100, "required_widget": CellType.ROLLOVER_SWITCH, "threshold": 3},
		&"phase_detonation": {"type": GoalArchetype.ORBIT_FLOW, "reward": RewardType.CONCUSSIVE_OVERDRIVE, "title": "Detonation Sequence", "desc": "Complete 1 orbit loop traversal.", "activation_req": "Complete 1 orbit loop.", "reward_desc": "+115 Energy Surge to ball", "energy": 115, "target_count": 1, "required_widget": CellType.ORBIT_LOOP, "threshold": 1},
		...
		&"impact_burst": {"type": GoalArchetype.SUPER_JETS, "reward": RewardType.GLOBAL_BOARD_KNOCK, "title": "Triple Bumper Bank", "desc": "Hit all 3 impact pop bumpers.", "activation_req": "Hit pop bumpers.", "reward_desc": "Global Board Knock (All pegs hit once)", "required_widget": CellType.POP_BUMPER, "threshold": 3},
		...
		&"static_bounce": {"type": GoalArchetype.ROLLOVER_SPELL, "reward": RewardType.ENERGY_SURGE, "title": "P-O-P Word Bank", "desc": "Spell P-O-P across divided lanes.", "activation_req": "Spell P-O-P across lanes.", "reward_desc": "+105 Energy Surge to ball", "energy": 105, "required_widget": CellType.ROLLOVER_SWITCH, "threshold": 3},
		...
		&"resonant_bounce": {"type": GoalArchetype.TARGET_BANK, "reward": RewardType.ENERGY_SURGE, "title": "Resonance Hurry-Up", "desc": "Knock down targets.", "activation_req": "Knock down targets.", "reward_desc": "+120 Energy Surge to ball", "energy": 120, "required_widget": CellType.DROP_TARGET, "threshold": 2},
		&"ricochet_blast": {"type": GoalArchetype.TARGET_BANK, "reward": RewardType.GLOBAL_BOARD_KNOCK, "title": "Ricochet Bank", "desc": "Knock down targets.", "activation_req": "Knock down targets.", "reward_desc": "Global Board Knock (All pegs hit once)", "required_widget": CellType.DROP_TARGET, "threshold": 3},
		...
		&"goblin_width_pulse": {"type": GoalArchetype.SINKHOLE_LOCK, "reward": RewardType.ENERGY_SURGE, "title": "Surge Chute", "desc": "Catch ball in ball trap.", "activation_req": "Catch ball in ball trap.", "reward_desc": "+110 Energy Surge to ball", "energy": 110, "required_widget": CellType.BALL_TRAP, "threshold": 1},
		...
		&"cluster_grenade": {"type": GoalArchetype.SUPER_JETS, "reward": RewardType.MULTIBALL_CASCADE, "title": "Cluster Munitions", "desc": "Hit pop bumpers.", "activation_req": "Hit pop bumpers.", "reward_desc": "Multiball Cascade (3 balls)", "balls": 3, "required_widget": CellType.POP_BUMPER, "threshold": 3},
		...
		&"fragment_echo": {"type": GoalArchetype.SINKHOLE_LOCK, "reward": RewardType.MULTIBALL_CASCADE, "title": "Echo Spawner", "desc": "Catch ball in ball trap.", "activation_req": "Catch ball in ball trap.", "reward_desc": "Multiball Cascade (2 echo balls)", "balls": 2, "required_widget": CellType.BALL_TRAP, "threshold": 1},
		...
		&"plain_surge": {"type": GoalArchetype.TARGET_BANK, "reward": RewardType.ENERGY_SURGE, "title": "Surge Bank", "desc": "Hit all components in module.", "activation_req": "Hit all components in module.", "reward_desc": "+60 Energy Surge to ball", "energy": 60, "threshold": 2},
		...
		&"plain_momentum": {"type": GoalArchetype.SEQUENCE_ROUTE, "reward": RewardType.ENERGY_SURGE, "title": "Momentum Lane", "desc": "Traverse sequence route.", "activation_req": "Traverse sequence route.", "reward_desc": "+70 Energy Surge to ball", "energy": 70, "threshold": 2},
		&"volt_primer": {"type": GoalArchetype.ROLLOVER_SPELL, "reward": RewardType.ENERGY_SURGE, "title": "G-O-B Word Bank", "desc": "Spell G-O-B across divided lanes.", "activation_req": "Spell G-O-B across lanes.", "reward_desc": "+75 Energy Surge to ball", "energy": 75, "required_widget": CellType.ROLLOVER_SWITCH, "threshold": 3},
		&"explosion_radius": {"type": GoalArchetype.TACTICAL_REBOUND, "reward": RewardType.CONCUSSIVE_OVERDRIVE, "title": "Blast Core", "desc": "Deflect off slingshot.", "activation_req": "Deflect off slingshot.", "reward_desc": "+70 Energy Surge to ball", "energy": 70, "required_widget": CellType.SLINGSHOT, "threshold": 1},
		...
		&"max_energize_stacks": {"type": GoalArchetype.SINKHOLE_LOCK, "reward": RewardType.BOARD_SUPERCHARGE, "title": "Capacitor Reservoir", "desc": "Fill wire gate cup.", "activation_req": "Fill wire gate reservoir.", "reward_desc": "Board Supercharge (+2 Energize stacks)", "required_widget": CellType.WIRE_GATE, "threshold": 1},
		...
		&"global_peg_durability": {"type": GoalArchetype.SUPER_JETS, "reward": RewardType.GLOBAL_BOARD_KNOCK, "title": "Armor Bank", "desc": "Hit pop bumpers.", "activation_req": "Hit pop bumpers.", "reward_desc": "Global Board Knock (All pegs hit once)", "required_widget": CellType.POP_BUMPER, "threshold": 2},
		...
		&"devastating_barrage": {"type": GoalArchetype.ROLLOVER_SPELL, "reward": RewardType.GLOBAL_BOARD_KNOCK, "title": "B-A-M Word Bank", "desc": "Spell B-A-M across divided lanes.", "activation_req": "Spell B-A-M across lanes.", "reward_desc": "Global Board Knock (All pegs hit once)", "required_widget": CellType.ROLLOVER_SWITCH, "threshold": 3},
		...
		&"abyssal_maw": {"type": GoalArchetype.SINKHOLE_LOCK, "reward": RewardType.MULTIBALL_CASCADE, "title": "Abyssal Eruption", "desc": "Capture balls in the abyssal maw.", "activation_req": "Catch ball in abyssal maw.", "reward_desc": "Multiball Cascade (3 balls)", "balls": 3, "required_widget": CellType.BALL_TRAP, "threshold": 1},
		...
		&"apex_orbit_loop": {"type": GoalArchetype.ORBIT_FLOW, "reward": RewardType.ENERGY_SURGE, "title": "Apex Turnaround", "desc": "Traverse the apex orbit loop.", "activation_req": "Traverse apex orbit loop.", "reward_desc": "+80 Energy Surge to ball", "energy": 80, "target_count": 1, "required_widget": CellType.ORBIT_LOOP, "threshold": 1},
...
static func _build_multi_peg_machinery() -> void:
	...
	_def_multi(&"abyssal_maw", "Abyssal Maw", 2, "2x2 Square Well", "Unified 4-Peg Ball Trap (Multi-Ball Eject Volley)", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {}, {}, {}, PolyominoModuleData.EnclosureType.OPEN_FRAME, {}, PolyominoModuleData.MachineryLayoutMode.UNIFIED, CellType.BALL_TRAP)
	...
	_def_multi(&"apex_orbit_loop", "Apex Orbit Loop", 1, "3-Peg V-Turnaround", "Unified 3-Peg V-Shape Orbit Loop (Turnaround Flow)", [Vector2i(0,1), Vector2i(1,0), Vector2i(2,1)], {}, {}, {}, PolyominoModuleData.EnclosureType.OPEN_FRAME, {}, PolyominoModuleData.MachineryLayoutMode.UNIFIED, CellType.ORBIT_LOOP)
	_def_multi(&"cyclone_orbit_loop", "Cyclone Orbit Loop", 2, "5-Peg U-Turnaround", "Unified 5-Peg U-Shape Wide Orbit Channel (Speed Boost)", [Vector2i(0,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1), Vector2i(2,0)], {}, {}, {}, PolyominoModuleData.EnclosureType.OPEN_FRAME, {}, PolyominoModuleData.MachineryLayoutMode.UNIFIED, CellType.ORBIT_LOOP)
	_def_multi(&"grand_orbit_circuit", "Grand Orbit Circuit", 3, "7-Peg Deep U-Loop", "Unified 7-Peg Deep U-Shape Grand Circuit (Massive Impulse)", [Vector2i(0,0), Vector2i(0,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(2,1), Vector2i(2,0)], {}, {}, {}, PolyominoModuleData.EnclosureType.OPEN_FRAME, {}, PolyominoModuleData.MachineryLayoutMode.UNIFIED, CellType.ORBIT_LOOP)
...
static func _build_boss_amplifiers() -> void:
	...
	_def(&"perpetual_engine", "Perpetual Engine", 3, "4x3 Pinball Loop", "Top Ball Lock + Accelerator Ring + Bumper Exit", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1), Vector2i(3,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(1,0): CellType.BALL_LOCK, Vector2i(0,1): CellType.ACCELERATOR, Vector2i(3,1): CellType.ACCELERATOR, Vector2i(1,2): CellType.BUMPER, Vector2i(2,2): CellType.BUMPER}, {Vector2i(1,0): Vector2i.DOWN, Vector2i(0,1): Vector2i.DOWN, Vector2i(3,1): Vector2i.UP}, {}, PolyominoModuleData.EnclosureType.DIRECTIONAL_FUNNEL)
	_def(&"storm_of_fragments", "Storm of Fragments", 3, "3x4 Diamond Chamber", "4 Pop Bumpers + Splitter Core", [Vector2i(1,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(0,3), Vector2i(1,3), Vector2i(2,3)], {Vector2i(1,0): CellType.POP_BUMPER, Vector2i(1,1): CellType.ROTARY_BOOSTER, Vector2i(0,1): CellType.POP_BUMPER, Vector2i(2,1): CellType.POP_BUMPER, Vector2i(1,3): CellType.POP_BUMPER}, {})
	...
	_def(&"fragment_swarm", "Fragment Swarm", 3, "3x4 Giant Arch", "Wire Gate Reservoir + 2 Guide Rails + 2 Heavy Bumpers", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(0,1), Vector2i(2,1), Vector2i(0,2), Vector2i(2,2), Vector2i(0,3), Vector2i(1,3), Vector2i(2,3), Vector2i(1,2)], {Vector2i(1,0): CellType.WIRE_GATE, Vector2i(0,1): CellType.GUIDE_RAIL, Vector2i(2,1): CellType.GUIDE_RAIL, Vector2i(0,3): CellType.BUMPER, Vector2i(2,3): CellType.BUMPER}, {Vector2i(1,0): Vector2i.DOWN}, {}, PolyominoModuleData.EnclosureType.DIRECTIONAL_FUNNEL)
	_def(&"overdrive_cascade", "Overdrive Cascade", 3, "4x3 Diamond Rhombus", "Central Orbit Loop + 3 Slingshots", [Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1), Vector2i(3,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2)], {Vector2i(1,1): CellType.ORBIT_LOOP, Vector2i(2,0): CellType.SLINGSHOT, Vector2i(0,1): CellType.SLINGSHOT, Vector2i(2,2): CellType.SLINGSHOT}, {Vector2i(2,0): Vector2i.UP, Vector2i(0,1): Vector2i.LEFT, Vector2i(2,2): Vector2i.DOWN})
	...
	_def(&"iron_bloom", "Iron Bloom", 3, "4x3 Solenoid Core", "4 Bash Toy Corner Targets + 2 Slingshot Kickers + 4 Open Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(3,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(0,0): CellType.BASH_TOY, Vector2i(3,0): CellType.BASH_TOY, Vector2i(0,2): CellType.BASH_TOY, Vector2i(3,2): CellType.BASH_TOY, Vector2i(1,0): CellType.SLINGSHOT, Vector2i(2,2): CellType.SLINGSHOT}, {})
...
static func _build_wall_break_cross_links() -> void:
	...
	_def(&"overcharged_drain", "Overcharged Drain", 2, "3x3 L-Chamber", "1 Wire Gate Reservoir + 2 Pop Bumpers + 1 Bumper", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2)], {Vector2i(0,0): CellType.WIRE_GATE, Vector2i(0,1): CellType.POP_BUMPER, Vector2i(0,2): CellType.POP_BUMPER, Vector2i(2,2): CellType.BUMPER}, {})
	...
	_def(&"phase_siphon", "Phase Siphon", 2, "3x3 V-Chamber", "3 Rollover Switches (W-I-N) + Divided Lanes + 2 Pop Bumpers", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(1,1), Vector2i(0,2), Vector2i(2,2)], {Vector2i(0,0): CellType.ROLLOVER_SWITCH, Vector2i(1,0): CellType.ROLLOVER_SWITCH, Vector2i(2,0): CellType.ROLLOVER_SWITCH, Vector2i(0,2): CellType.POP_BUMPER, Vector2i(2,2): CellType.POP_BUMPER}, {}, {}, PolyominoModuleData.EnclosureType.DIVIDED_LANES, {}, {Vector2i(0,0): "W", Vector2i(1,0): "I", Vector2i(2,0): "N"})
	...
	_def(&"static_bounce", "Static Bounce", 2, "3x3 L-Chamber", "3 Rollover Switches (P-O-P) + Divided Lanes + 2 Pop Bumpers", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1), Vector2i(0,2), Vector2i(1,2)], {Vector2i(0,0): CellType.ROLLOVER_SWITCH, Vector2i(1,0): CellType.ROLLOVER_SWITCH, Vector2i(0,1): CellType.ROLLOVER_SWITCH, Vector2i(0,2): CellType.POP_BUMPER, Vector2i(1,2): CellType.POP_BUMPER}, {}, {}, PolyominoModuleData.EnclosureType.DIVIDED_LANES, {}, {Vector2i(0,0): "P", Vector2i(1,0): "O", Vector2i(0,1): "P"})
	...
	_def(&"blast_launch", "Blast Launch", 2, "3x3 V-Chamber", "2 Pop Bumpers + 1 Vertical Up Kicker + 3 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(1,1), Vector2i(0,2), Vector2i(2,2)], {Vector2i(0,0): CellType.POP_BUMPER, Vector2i(1,1): CellType.VERTICAL_UP_KICKER, Vector2i(2,0): CellType.POP_BUMPER}, {Vector2i(1,1): Vector2i.UP})
	...
	_def(&"goblin_width_pulse", "Goblin Surge Chute", 2, "3x3 Skew Chamber", "1 Rotary Sensor + 2 Ball Traps + 3 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(1,1), Vector2i(2,1), Vector2i(2,2)], {Vector2i(0,0): CellType.ROTARY_BOOSTER, Vector2i(1,0): CellType.BALL_TRAP, Vector2i(2,2): CellType.BALL_TRAP}, {})
...
static func _build_single_ball_enhancements() -> void:
	...
	_def(&"fragment_echo", "Fragment Echo", 1, "3x2 Horizontal Bar", "1 Ball Trap + 1 Top Spawner + 3 Free Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(0,1), Vector2i(2,1)], {Vector2i(0,0): CellType.BALL_TRAP, Vector2i(2,0): CellType.ROTARY_BOOSTER}, {})
...
static func _build_treasure_chest_passives() -> void:
	...
	_def(&"max_energize_stacks", "Deeper Energize", 1, "2x2 Box Chamber", "1 Wire Gate Reservoir + 1 Pop Bumper + 2 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.WIRE_GATE, Vector2i(1,1): CellType.POP_BUMPER}, {})
	...
	_def(&"devastating_barrage", "Devastating Barrage", 1, "2x3 L-Chamber", "3 Rollover Switches (B-A-M) + Divided Lanes + 1 Rotary Booster", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(0,2), Vector2i(1,2)], {Vector2i(0,0): CellType.ROLLOVER_SWITCH, Vector2i(0,1): CellType.ROLLOVER_SWITCH, Vector2i(0,2): CellType.ROLLOVER_SWITCH, Vector2i(1,0): CellType.ROTARY_BOOSTER}, {}, {}, PolyominoModuleData.EnclosureType.DIVIDED_LANES, {}, {Vector2i(0,0): "B", Vector2i(0,1): "A", Vector2i(0,2): "M"})
