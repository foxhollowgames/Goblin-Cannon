...
static func _build_boss_amplifiers() -> void:
	...
	_def(&"fragment_swarm", "Fragment Swarm", 3, "3x4 Giant Arch", "Top Catch Funnel + 2 Spark Deflectors + 2 Heavy Bumpers", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(0,1), Vector2i(2,1), Vector2i(0,2), Vector2i(2,2), Vector2i(0,3), Vector2i(1,3), Vector2i(2,3), Vector2i(1,2)], {Vector2i(1,0): CellType.FUNNEL, Vector2i(0,1): CellType.DIRECTIONAL_DEFLECTOR, Vector2i(2,1): CellType.DIRECTIONAL_DEFLECTOR, Vector2i(0,3): CellType.BUMPER, Vector2i(2,3): CellType.BUMPER}, {Vector2i(1,0): Vector2i.DOWN, Vector2i(0,1): Vector2i.LEFT, Vector2i(2,1): Vector2i.RIGHT}, {}, PolyominoModuleData.EnclosureType.DIRECTIONAL_FUNNEL)
