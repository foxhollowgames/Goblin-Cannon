...
static func _get_goal_def(id: StringName) -> Dictionary:
	var defs: Dictionary = {
		&"cascade_reactor": {"type": GoalArchetype.TARGET_BANK, "reward": RewardType.BOARD_SUPERCHARGE, "title": "Reactor Core Ignition", "desc": "Hit all 4 corner boosters + center siphon.", "activation_req": "Hit all 4 corner boosters and center siphon.", "reward_desc": "Board Supercharge (+3 Energize to all pegs)"},
		...
		&"renewal_pact": {"type": GoalArchetype.TACTICAL_REBOUND, "reward": RewardType.GLOBAL_BOARD_KNOCK, "title": "Pact Solenoid", "desc": "Trigger 3 outlane kickback solenoids.", "activation_req": "Trigger 3 outlane kickbacks.", "reward_desc": "Global Board Knock (All pegs hit once)", "required_widget": CellType.OUTLANE_KICKBACK, "threshold": 3},
		...
		&"echoes_of_wrench": {"type": GoalArchetype.STANDUP_BANK, "reward": RewardType.ENERGY_SURGE, "title": "Wrench Circuit", "desc": "Hit both upright standup targets.", "activation_req": "Hit both standup targets.", "reward_desc": "+175 Energy Surge to ball", "energy": 175, "required_widget": CellType.STANDUP_TARGET, "threshold": 2},
		...
		&"supernova_peg": {"type": GoalArchetype.STANDUP_BANK, "reward": RewardType.CONCUSSIVE_OVERDRIVE, "title": "Supernova Ignition", "desc": "Hit both standup targets.", "activation_req": "Hit both standup targets.", "reward_desc": "Concussive Overdrive Blast +130 Energy", "energy": 130, "required_widget": CellType.STANDUP_TARGET, "threshold": 2},
		...
		&"resonant_bounce": {"type": GoalArchetype.STANDUP_BANK, "reward": RewardType.ENERGY_SURGE, "title": "Resonance Hurry-Up", "desc": "Hit both resonant standup targets.", "activation_req": "Hit both standup targets.", "reward_desc": "+120 Energy Surge to ball", "energy": 120, "required_widget": CellType.STANDUP_TARGET, "threshold": 2},
		...
		&"arc_surge_wrench": {"type": GoalArchetype.TACTICAL_REBOUND, "reward": RewardType.BOARD_SUPERCHARGE, "title": "Dual Solenoids", "desc": "Trigger outlane kickback.", "activation_req": "Trigger outlane kickback.", "reward_desc": "Board Supercharge (+2 Energize stacks)", "required_widget": CellType.OUTLANE_KICKBACK, "threshold": 1},
		...
		&"overdrive_hits": {"type": GoalArchetype.STANDUP_BANK, "reward": RewardType.ENERGY_SURGE, "title": "Overdrive Bank", "desc": "Hit standup target.", "activation_req": "Hit standup target.", "reward_desc": "+75 Energy Surge to ball", "energy": 75, "required_widget": CellType.STANDUP_TARGET, "threshold": 1},
		...
		&"fragmentation_tag": {"type": GoalArchetype.STANDUP_BANK, "reward": RewardType.ENERGY_SURGE, "title": "Impact Tag", "desc": "Hit impact standup target.", "activation_req": "Hit standup target.", "reward_desc": "+65 Energy Surge to ball", "energy": 65, "required_widget": CellType.STANDUP_TARGET, "threshold": 1},
		...
		&"explosion_radius": {"type": GoalArchetype.TACTICAL_REBOUND, "reward": RewardType.CONCUSSIVE_OVERDRIVE, "title": "Blast Core", "desc": "Trigger outlane kickback.", "activation_req": "Trigger outlane kickback.", "reward_desc": "Concussive Overdrive Blast", "energy": 70, "required_widget": CellType.OUTLANE_KICKBACK, "threshold": 1},
		...
		&"peg_recovery_speed": {"type": GoalArchetype.TACTICAL_REBOUND, "reward": RewardType.GLOBAL_BOARD_KNOCK, "title": "Reset Matrix", "desc": "Trigger recovery kickback.", "activation_req": "Trigger outlane kickback.", "reward_desc": "Global Board Knock (All pegs hit once)", "required_widget": CellType.OUTLANE_KICKBACK, "threshold": 1},
		...
		&"compressed_charge": {"type": GoalArchetype.JACKPOT_ACCUMULATOR, "reward": RewardType.ENERGY_SURGE, "title": "Charge Capacitor", "desc": "Capacitors charge, siphon collects.", "activation_req": "Charge siphons and collect.", "reward_desc": "+100 Energy Surge to ball", "energy": 100},
		&"chest_leech_drain": {"type": GoalArchetype.TACTICAL_REBOUND, "reward": RewardType.ENERGY_SURGE, "title": "Leech Siphon Bank", "desc": "Deflect off drain slingshot.", "activation_req": "Deflect off slingshot.", "reward_desc": "+55 Energy Surge to ball", "energy": 55, "required_widget": CellType.SLINGSHOT, "threshold": 1},
		...
		&"chest_bounce_energy": {"type": GoalArchetype.STANDUP_BANK, "reward": RewardType.ENERGY_SURGE, "title": "Bounce Pair", "desc": "Hit bounce standup target.", "activation_req": "Hit standup target.", "reward_desc": "+50 Energy Surge to ball", "energy": 50, "required_widget": CellType.STANDUP_TARGET, "threshold": 1},
...
static func _build_boss_amplifiers() -> void:
	...
	_def(&"explosive_contagion", "Explosive Contagion", 3, "4x3 Z-Chamber", "3 Slingshots + 2 Spore Siphons + 5 Free Corridors", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1), Vector2i(3,1), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(0,0): CellType.SLINGSHOT, Vector2i(2,1): CellType.SLINGSHOT, Vector2i(3,2): CellType.SLINGSHOT, Vector2i(1,0): CellType.MANA_SIPHON, Vector2i(2,2): CellType.MANA_SIPHON}, {})
	...
	_def(&"blood_tithe", "Blood Tithe", 3, "4x3 Horseshoe Arch", "Central Bash Toy + 3 High-Volume Drain Siphons", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(3,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(1,0): CellType.BASH_TOY, Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(3,0): CellType.MANA_SIPHON, Vector2i(0,2): CellType.MANA_SIPHON}, {Vector2i(1,0): Vector2i.DOWN}, {}, PolyominoModuleData.EnclosureType.DIRECTIONAL_FUNNEL)
	...
	_def(&"twin_mandate", "Twin Mandate", 3, "4x3 Dual Track", "2 Orbit Loops + 2 Energy Siphons + 6 Bounce Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1), Vector2i(3,1), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2), Vector2i(0,2)], {Vector2i(0,0): CellType.ORBIT_LOOP, Vector2i(3,2): CellType.ORBIT_LOOP, Vector2i(1,0): CellType.MANA_SIPHON, Vector2i(2,1): CellType.MANA_SIPHON}, {Vector2i(0,0): Vector2i.RIGHT, Vector2i(3,2): Vector2i.LEFT}, {}, PolyominoModuleData.EnclosureType.DIVIDED_LANES)
	...
	_def(&"phase_sovereign", "Phase Sovereign", 3, "4x3 Spectral Tunnel", "1 Mechanical Diverter + 3 Siphon Nodes + 7 Open Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(1,1), Vector2i(3,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(1,0): CellType.MECHANICAL_DIVERTER, Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(3,0): CellType.MANA_SIPHON, Vector2i(1,1): CellType.MANA_SIPHON}, {})
	_def(&"resonant_well", "Resonant Well", 3, "4x3 Resonator Ring", "2 Spinners + 2 Energize Siphons + 8 Travel Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1), Vector2i(3,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(1,0): CellType.SPINNER, Vector2i(2,2): CellType.SPINNER, Vector2i(0,1): CellType.MANA_SIPHON, Vector2i(3,1): CellType.MANA_SIPHON}, {})
	_def(&"renewal_pact", "Renewal Pact", 3, "4x3 Solenoid Field", "3 Outlane Kickbacks + 2 Repair Siphons + 5 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(1,1), Vector2i(2,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(0,0): CellType.OUTLANE_KICKBACK, Vector2i(3,0): CellType.OUTLANE_KICKBACK, Vector2i(1,1): CellType.OUTLANE_KICKBACK, Vector2i(0,2): CellType.MANA_SIPHON, Vector2i(3,2): CellType.MANA_SIPHON}, {})
	...
	_def(&"echoes_of_wrench", "Echoes of the Wrench", 3, "4x3 T-Beam Frame", "2 Standup Targets + 2 Repair Siphons + 1 Central Booster", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1), Vector2i(3,1), Vector2i(1,2), Vector2i(2,2)], {Vector2i(0,0): CellType.STANDUP_TARGET, Vector2i(3,0): CellType.STANDUP_TARGET, Vector2i(1,0): CellType.MANA_SIPHON, Vector2i(2,2): CellType.MANA_SIPHON, Vector2i(1,1): CellType.ROTARY_BOOSTER}, {})
	...
	_def(&"leech_singularity", "Leech Singularity", 3, "4x3 Arch Siphon", "1 Captive Ball + 3 High-Volume Siphons + 6 Open Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(3,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(1,0): CellType.CAPTIVE_BALL, Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(3,0): CellType.MANA_SIPHON, Vector2i(0,2): CellType.MANA_SIPHON}, {})
	_def(&"phantom_resonance", "Phantom Resonance", 3, "4x3 Spectral Loop", "1 Guide Track Core + 3 Siphons + 2 Rails + 5 Open Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(3,0), Vector2i(0,1), Vector2i(1,1), Vector2i(3,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2), Vector2i(3,2)], {Vector2i(1,0): CellType.GUIDE_TRACK, Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(3,0): CellType.MANA_SIPHON, Vector2i(1,1): CellType.MANA_SIPHON, Vector2i(0,2): CellType.GUIDE_RAIL, Vector2i(3,2): CellType.GUIDE_RAIL}, {})

static func _build_wall_break_cross_links() -> void:
	_def(&"supernova_peg", "Supernova Peg", 2, "3x3 Box Chamber", "1 Rotary Booster + 2 Standup Targets + 4 Open Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(0,1), Vector2i(2,1), Vector2i(0,2), Vector2i(2,2)], {Vector2i(0,0): CellType.ROTARY_BOOSTER, Vector2i(2,0): CellType.STANDUP_TARGET, Vector2i(2,2): CellType.STANDUP_TARGET}, {})
	...
	_def(&"overcharged_drain", "Overcharged Drain", 2, "3x3 L-Chamber", "1 Scoop Sinkhole + 2 Siphons + 1 Bumper", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2)], {Vector2i(0,0): CellType.SCOOP_SINKHOLE, Vector2i(0,1): CellType.MANA_SIPHON, Vector2i(0,2): CellType.MANA_SIPHON, Vector2i(2,2): CellType.BUMPER}, {})
	...
	_def(&"energy_collapse", "Energy Collapse", 2, "3x3 Z-Chamber", "2 Siphons + 2 Drop Targets + 3 Open Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(1,1), Vector2i(0,2), Vector2i(1,2), Vector2i(2,2)], {Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(1,0): CellType.MANA_SIPHON, Vector2i(1,1): CellType.DROP_TARGET, Vector2i(2,2): CellType.DROP_TARGET}, {})
	...
	_def(&"phase_siphon", "Phase Siphon", 2, "3x3 V-Chamber", "2 Siphon Nodes + 1 Rollover Switch + 3 Open Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(1,1), Vector2i(0,2), Vector2i(2,2)], {Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(1,1): CellType.MANA_SIPHON, Vector2i(2,0): CellType.ROLLOVER_SWITCH}, {})
	...
	_def(&"kinetic_charge", "Kinetic Charge", 2, "3x3 Skew Chamber", "1 Spinner + 1 Siphon + 1 Rotary Core + 3 Open Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(1,1), Vector2i(2,1), Vector2i(2,2)], {Vector2i(0,0): CellType.SPINNER, Vector2i(1,0): CellType.MANA_SIPHON, Vector2i(2,2): CellType.ROTARY_BOOSTER}, {})
	...
	_def(&"parasitic_arc", "Parasitic Arc", 2, "3x3 V-Chamber", "2 Mechanical Diverters + 1 Drain Siphon", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(1,1), Vector2i(0,2), Vector2i(2,2)], {Vector2i(0,0): CellType.MECHANICAL_DIVERTER, Vector2i(1,1): CellType.MANA_SIPHON, Vector2i(2,0): CellType.MECHANICAL_DIVERTER}, {Vector2i(0,0): Vector2i.LEFT, Vector2i(2,0): Vector2i.RIGHT})
	_def(&"draining_fragments", "Draining Fragments", 2, "3x3 Skew Chamber", "2 Fragment Siphons + 1 Slingshot + 3 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(1,1), Vector2i(2,1), Vector2i(2,2)], {Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(1,0): CellType.MANA_SIPHON, Vector2i(2,2): CellType.SLINGSHOT}, {})
	_def(&"resonant_bounce", "Resonant Bounce", 2, "3x3 Straight Chamber", "2 Standup Targets + 1 Tuning Core + 3 Open Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1)], {Vector2i(0,0): CellType.STANDUP_TARGET, Vector2i(1,0): CellType.ROTARY_BOOSTER, Vector2i(2,0): CellType.STANDUP_TARGET}, {})
	...
	_def(&"arc_surge_wrench", "Arc Surge Wrench", 2, "3x3 Straight Chamber", "2 Outlane Kickbacks + 1 Wire Harness + 3 Travel Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(0,1), Vector2i(1,1), Vector2i(2,1)], {Vector2i(0,0): CellType.OUTLANE_KICKBACK, Vector2i(1,0): CellType.GUIDE_RAIL, Vector2i(2,0): CellType.OUTLANE_KICKBACK}, {})
...
static func _build_single_ball_enhancements() -> void:
	...
	_def(&"overdrive_hits", "Overdrive Hits", 1, "2x2 Box Chamber", "1 Standup Target + 1 Overdrive Multiplier", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.STANDUP_TARGET, Vector2i(1,1): CellType.ROTARY_BOOSTER}, {})
	...
	_def(&"spreading_rot", "Spreading Rot", 1, "2x3 L-Shape", "2 Rot Siphons + 1 Drop Target + 2 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(0,2), Vector2i(1,2)], {Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(0,1): CellType.MANA_SIPHON, Vector2i(1,2): CellType.DROP_TARGET}, {})
	...
	_def(&"fragmentation_tag", "Fragmentation Tag", 1, "2x2 Box Chamber", "1 Standup Target + 1 Rotary Sensor + 2 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.STANDUP_TARGET, Vector2i(1,1): CellType.ROTARY_BOOSTER}, {})
	...
	_def(&"ghost_trail", "Ghost Trail", 1, "2x3 Vertical Track", "1 Guide Track + 1 Siphon + 3 Open Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1), Vector2i(0,2)], {Vector2i(0,0): CellType.GUIDE_TRACK, Vector2i(0,2): CellType.MANA_SIPHON}, {})
...
static func _build_treasure_chest_passives() -> void:
	_def(&"explosion_radius", "Bigger Blasts", 1, "2x2 Box Chamber", "1 Outlane Kickback + 1 Pop Bumper + 2 Free Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.OUTLANE_KICKBACK, Vector2i(1,1): CellType.ROTARY_BOOSTER}, {})
	...
	_def(&"max_energize_stacks", "Deeper Energize", 1, "2x2 Box Chamber", "1 Scoop Sinkhole + 1 Siphon + 2 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.SCOOP_SINKHOLE, Vector2i(1,1): CellType.MANA_SIPHON}, {})
	_def(&"energize_decays_slower", "Slower Energize Fade", 1, "2x3 Vertical Bar", "1 Guide Track + 1 Siphon + 3 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1), Vector2i(0,2)], {Vector2i(0,0): CellType.GUIDE_TRACK, Vector2i(0,2): CellType.MANA_SIPHON}, {})
	_def(&"energized_pegs_repair_faster", "Fast Heal (Energized)", 1, "2x2 Box Chamber", "1 Guide Track + 1 Siphon + 2 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.GUIDE_TRACK, Vector2i(1,1): CellType.MANA_SIPHON}, {})
	...
	_def(&"peg_recovery_speed", "Faster Peg Recovery", 1, "3x2 Chevron", "2 Outlane Kickbacks + 1 Spring Roller + 2 Free Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(2,0), Vector2i(0,1), Vector2i(2,1)], {Vector2i(0,0): CellType.OUTLANE_KICKBACK, Vector2i(2,0): CellType.OUTLANE_KICKBACK, Vector2i(1,0): CellType.ACCELERATOR}, {})
	...
	_def(&"compressed_charge", "Compressed Charge", 1, "2x3 L-Chamber", "2 Ball Locks + 1 Siphon + 2 Free Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(0,2), Vector2i(1,2)], {Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(0,1): CellType.BALL_LOCK, Vector2i(1,2): CellType.BALL_LOCK}, {})
	_def(&"chest_leech_drain", "Leech Drain Up", 1, "2x2 Box Chamber", "1 Slingshot + 1 Drain Siphon + 2 Free Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(1,1): CellType.SLINGSHOT}, {})
	_def(&"chest_leech_duration", "Longer Leech", 1, "2x3 Vertical Bar", "1 Leech Siphon + 1 Guide Track + 3 Free Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1), Vector2i(0,2)], {Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(0,2): CellType.GUIDE_TRACK}, {})
	_def(&"chest_phantom_energy", "Phantom Energy", 1, "2x2 Box Chamber", "1 Spectral Siphon + 1 Guide Track + 2 Free Cells", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.MANA_SIPHON, Vector2i(1,1): CellType.GUIDE_TRACK}, {})
	...
	_def(&"chest_bounce_energy", "Plain Energy", 1, "2x2 Box Chamber", "1 Standup Target + 1 Rotary Sensor + 2 Free Spaces", [Vector2i(0,0), Vector2i(1,0), Vector2i(0,1), Vector2i(1,1)], {Vector2i(0,0): CellType.STANDUP_TARGET, Vector2i(1,1): CellType.ROTARY_BOOSTER}, {})
